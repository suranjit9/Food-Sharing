...
//         const fromData = {img , donerName, email, donerImage, foodName,FoodImage, Location, Quantity, Expired, ExpiredTime, Notes, FoodStatus };
...
//                         <label className="input-group">
//                             {/* <input type="text" name='FoodImage' onChange={(e) => setImg(e.target.files[0])} placeholder="Food Image url" required className="input input-bordered w-full max-w-xl" /> */}
//                             <input type="file" name='FoodImage' onChange={(e) => setImg(e.target.files[0])} className="file-input file-input-bordered w-full max-w-xs" />
//                         </label>
